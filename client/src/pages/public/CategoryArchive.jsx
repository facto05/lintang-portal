    ...
    <div>
      <div className="bg-black text-white py-8">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          {data.category.description && <p className="mt-2 text-gray-100">{data.category.description}</p>}
        </div>
      </div>
              ...
              <article key={post.id} className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition">
                <Link to={`/posts/${post.slug}`} className="flex flex-col md:flex-row">
                  ...
                  <div className="flex-1 p-6">
                    ...
                    <div className="mt-4">
                      <span className="text-black text-sm font-medium hover:underline">Baca Selengkapnya →</span>
                    </div>
                  </div>
                </Link>
              </article>
