...
<div class="max-w-4xl">
    ...
    <form method="POST" action="{{ route('admin.categories.store') }}" class="space-y-6 bg-white shadow rounded-lg p-6">
        @csrf
        ...
        <div>
            ...
            <select name="type" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500">
                ...
                <option value="press_release" {{ old('type') == 'press_release' ? 'selected' : '' }}>Press Release</option>
        ...
        <div class="flex gap-4">
            <button type="submit" class="bg-red-700 text-white px-6 py-2 rounded hover:bg-red-800">Create Category</button>
